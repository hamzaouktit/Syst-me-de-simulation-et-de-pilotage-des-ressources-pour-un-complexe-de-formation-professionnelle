...
{{-- Sidebar pour Directeur Complexe --}}
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <i class="fas fa-building"></i>
        </div>
        <h5><i class="fas fa-city me-2"></i>Directeur Complexe</h5>
    ...
    <nav class="sidebar-nav">
        <div class="sidebar-nav-item">
            <a href="{{ route('dashboard.complexe') }}" 
               class="sidebar-nav-link {{ request()->routeIs('dashboard.complexe') ? 'active' : '' }}">
        ...
        <div class="sidebar-nav-item">
            <a href="{{ route('administrationcomplexe.directeurs.index') }}" 
               class="sidebar-nav-link {{ request()->routeIs('administrationcomplexe.directeurs.*') ? 'active' : '' }}">
                <div class="nav-icon-wrapper">
                    <i class="fas fa-user-tie sidebar-nav-icon"></i>
                </div>
                <span>Gestion Directeurs</span>
                <div class="nav-arrow">
                    <i class="fas fa-chevron-right"></i>
                </div>
            </a>
        ...
        <div class="sidebar-nav-item">
            <a href="{{ route('administrationcomplexe.etablissements.index') }}" 
               class="sidebar-nav-link {{ request()->routeIs('administrationcomplexe.etablissements.*') ? 'active' : '' }}">
                <div class="nav-icon-wrapper">
...
{{--
        ...
        <div class="sidebar-nav-item">
            <a href="#" class="sidebar-nav-link">
                ...
                <span>Effectifs par Établissement</span>
                <div class="nav-arrow">
                    <i class="fas fa-chevron-right"></i>
                </div>
            </a>
        ...
        <div class="sidebar-nav-item">
            <a href="#" class="sidebar-nav-link">
                ...
                <span>Formations du Complexe</span>
                <div class="nav-arrow">
                    <i class="fas fa-chevron-right"></i>
                </div>
            </a>
...
<style>
    /* Styles pour la sidebar complexe - Version optimisée */
    :root {
        --sidebar-width: 280px;
        --ofppt-blue: #1e3a8a;
        --ofppt-dark-blue: #1e40af;
        --ofppt-green: #2e8b57;
    }
...
<script>
    // Fonctions pour contrôler la sidebar complexe - Version améliorée
