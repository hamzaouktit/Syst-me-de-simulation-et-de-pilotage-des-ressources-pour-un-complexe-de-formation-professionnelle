...
<div class="container">
    <div class="mb-4 d-flex align-items-center gap-3">
        ...
        <h1 class="h3 fw-bold mb-0">Créer un Module</h1>
    </div>

    <form action="{{ route('administrationetablissement.modules.store') }}" method="POST" novalidate>
        @csrf
        ...
        <div class="mb-4">
            ...
            <select id="formation_id" 
                    ...
                    required>
                <option value="" disabled {{ old('formation_id') ? '' : 'selected' }}>Sélectionnez une formation</option>
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button type="submit" class="btn btn-success">
                <i class="fas fa-check me-2"></i> Créer le Module
            </button>
        </div>
    </form>
</div>
